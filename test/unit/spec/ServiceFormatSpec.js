describe("Format service", function() {
  ...
  describe('formatting functions', function() {
    it("should format reactions", function() {
      ...
      value = spec.format.reactionFormat(1, spec.data.syntheses['1H-p']);
    ...
    it("should format multiple reactions", function() {
      ...
      value = spec.format.reactionFormat(10, spec.data.syntheses['1H-p']);
    ...
    it("should format single compounds", function() {
      ...
      value = spec.format.compoundFormat(1, spec.data.syntheses['1H-p'].product);
    ...
    it("should format mutiple compounds", function() {
      ...
      value = spec.format.compoundFormat(10, spec.data.syntheses['1H-p'].product);
